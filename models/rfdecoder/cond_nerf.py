...
class CondNeRF(NeRF):
    ...
    def define_network(self, opt):
        ...
        self.alpha_linear.apply(self.weights_initgeo)
        self.rgb_linear.apply(self.weights_initgeo)
    ...
    #
    def weights_initgeo(self,m):
        if isinstance(m, torch.nn.Linear):
            stdv = 1.0 / torch.sqrt(torch.tensor(m.weight.size(1)))
